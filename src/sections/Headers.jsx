...
const Headers = () => {
  ...
  return (
    <div className="flex items-center justify-center">
      <div className="flex fixed top-0 left-1/2 -translate-x-1/2 items-center justify-between backdrop-blur-3xl lg:backdrop-blur-none border-b-2 border-n-4/20 lg:border-none  h-16 md:h-20 lg:mt-5 z-50 md:px-4 px-2 w-full lg:px-12">
